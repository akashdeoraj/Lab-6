...
def normalise_input(user_input):
    ...
    no_punct = remove_punct(new)
    listofwords = no_punct.split()
    filter_words(listofwords,skip_words)
    return filter_words(listofwords,skip_words)
    #
    # COMPLETE ME!
    #
